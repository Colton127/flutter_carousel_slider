...
class CarouselSliderState extends State<CarouselSlider> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    carouselState?.currentPage = widget.options.initialPage;
    carouselState!.pageController = pageController;
  }
  ...
  Widget build(BuildContext context) {
    return getGestureWrapper(PageView.builder(
      ...
      onPageChanged: (int index) {
        int _currentPage = getRealIndex(index + carouselState!.initialPage, carouselState!.realPage, widget.itemCount);
        carouselState?.currentPage = _currentPage;
        if (widget.options.onPageChanged != null) {
          widget.options.onPageChanged!(_currentPage, mode);
        }
      },
